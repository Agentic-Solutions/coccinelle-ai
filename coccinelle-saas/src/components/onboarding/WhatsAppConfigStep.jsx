...
export default function WhatsAppConfigStep({ onNext, onBack, loading }) {
  ...
  const handleSubmit = () => {
    if (skipConfig) {
      onNext({
        whatsapp: {
          configured: false,
          message: 'Configuration WhatsApp à faire plus tard dans Paramètres > Canaux'
        }
      });
    } else {
      onNext({
  ...
  return (
    <div>
      ...
      <p className="text-gray-600 mb-8">
        Configurez l'envoi de messages WhatsApp Business.
      </p>
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <div className="font-medium text-black">Canal WhatsApp activé</div>
