  ...
  return (
    <div className="text-center">
      <div className="flex items-center justify-center mb-4">
        ...
        <h2 className="text-2xl font-bold text-gray-900">Quel est votre secteur d&apos;activite ?</h2>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 max-w-2xl mx-auto">
        {SECTORS.map(s => (
          <button
            ...
            `}
          >
            <span className={sector === s.value ? 'text-[#D85A30]' : 'text-gray-500'}>
              {SECTOR_ICONS[s.value] || SECTOR_ICONS.autre}
            </span>
            <span className={`font-medium text-sm ${sector === s.value ? 'text-[#D85A30]' : 'text-gray-700'}`}>
              {s.label}
            </span>
          </button>
        ))}
