...
export default function EmailConfigStep({ onNext, onBack, loading }) {
  ...
  const handleSubmit = () => {
    if (skipConfig) {
      onNext({
        email: {
          configured: false,
          message: 'Configuration Email à faire plus tard dans Paramètres > Canaux'
        }
      });
    } else {
      onNext({
  ...
  return (
    <div>
      ...
      <p className="text-gray-600 mb-8">
        Configurez l'envoi d'emails automatisés.
      </p>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-blue-800 mb-3">
              La configuration complète de l'email (SMTP, expéditeur, templates, etc.)
              peut être effectuée après l'onboarding dans <strong>Paramètres &gt; Canaux &gt; Email</strong>.
            </p>
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <div className="font-medium text-black">Canal Email activé</div>
