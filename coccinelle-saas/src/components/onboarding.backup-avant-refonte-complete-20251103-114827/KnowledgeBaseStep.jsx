        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            <div className="border border-gray-200 rounded-lg p-6 text-center">
              ...
              <div className="text-sm text-gray-600">Documents créés</div>
            </div>
            ...
            <div className="border border-gray-200 rounded-lg p-6 text-center">
              ...
              <div className="text-sm text-gray-600">FAQs ajoutées</div>
            </div>
          </div>
          ...
          {kbData?.crawl_job_id && (
            <div className="bg-white border border-blue-200 rounded-lg p-4 mb-6">
              <p className="text-blue-800 text-sm">
                🕷 Le crawl de votre site est en cours... Les pages seront ajoutées automatiquement.
              </p>
            </div>
          )}
