      ...
      {!configured ? (
        <div className="bg-gradient-to-br from-purple-50 to-pink-50 border-2 border-purple-200 rounded-xl p-8 text-center">
          ...
          <button
            ...
            className="px-8 py-4 bg-purple-600 text-white dark:text-black font-semibold rounded-xl hover:bg-purple-700 disabled:opacity-50 transition-all shadow-lg"
          >
            {configuring ? (
              <>
