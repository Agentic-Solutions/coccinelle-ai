      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          ...
          <input
            ...
            className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-indigo-500 ${errors.company_name ? 'border-red-500' : 'border-neutral-300 dark:border-neutral-700'}`}
          ...
          <div className="grid grid-cols-2 gap-3">
            {INDUSTRIES.map((industry) => (
              <button
                ...
                className={`p-4 border-2 rounded-lg text-left transition-all ${formData.industry === industry.value ? 'border-indigo-600 bg-indigo-50' : 'border-gray-200 hover:border-neutral-300 dark:border-neutral-700'}`}
              >
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-4 py-3 border rounded-lg ${errors.phone ? 'border-red-500' : 'border-neutral-300 dark:border-neutral-700'}`}
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full py-4 bg-black dark:bg-white text-white dark:text-black font-semibold rounded-lg hover:bg-neutral-800 dark:hover:bg-neutral-200 disabled:opacity-50 transition-all"
        >
