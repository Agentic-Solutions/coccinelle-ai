      ...
      {!generated ? (
        <div className="bg-gradient-to-br from-indigo-50 to-purple-50 border-2 border-indigo-200 rounded-xl p-8 text-center">
          ...
          <button
            ...
            disabled={generating}
            className="px-8 py-4 bg-black dark:bg-white text-white dark:text-black font-semibold rounded-xl hover:bg-neutral-800 dark:hover:bg-neutral-200 disabled:opacity-50 transition-all shadow-lg"
          >
            {generating ? (
              <>
                  ...
                  <div>
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-neutral-600 dark:text-neutral-400">{agent.email}</p>
                      </div>
                    </div>
                    <div className="ml-15">
