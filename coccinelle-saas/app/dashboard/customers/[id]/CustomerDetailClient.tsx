    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">Ce client n&apos;existe pas ou a été supprimé.</p>
          <a href="/dashboard/customers" className="inline-flex items-center gap-2 px-4 py-2 bg-gray-900 text-white rounded-lg hover:bg-gray-800">
            <ArrowLeft size={16} />
            Retour aux clients
          </a>
        </div>
