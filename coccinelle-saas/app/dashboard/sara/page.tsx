...
export default function SaraConfigPage() {
  ...
  const [script, setScript] = useState(`Bonjour ! Je suis Sara, l'assistante vocale de {AGENCY_NAME}.
...
Puis-je vous proposer un rendez-vous avec un de nos conseillers ?`);
  ...
  const handleSave = () => {
    console.log('Saving Sara configuration...', {
      voiceConfig,
      personality,
      qualificationCriteria,
      script
    });
    alert('Configuration de Sara sauvegardée avec succès !');
  };
      ...
      <div className="max-w-7xl mx-auto px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            ...
            <p className="text-2xl font-bold text-gray-900">Sara</p>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
          ...
          <div className="p-6">
            ...
            {activeTab === 'personality' && (
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">Personnalité de Sara</h3>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    Sélectionnez les informations que Sara doit collecter pour qualifier un lead
                  </p>
