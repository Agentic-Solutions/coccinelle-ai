...
const CIBLE = '/dashboard/assistant/';
 ...
 * d'information.
 *
 * Pointe desormais DIRECTEMENT sur /dashboard/assistant : deux autres
 * redirections visaient cette page, qui etait elle-meme cassee — double saut
 * mort.
 */
export default function SaraRedirect() {
  return (
    <>
      <meta httpEquiv="refresh" content={`0; url=${CIBLE}`} />
      <div className="min-h-screen bg-white flex items-center justify-center px-4">
        <p className="text-gray-600 text-center">
          Votre assistant a change d&apos;adresse.{' '}
          <Link href={CIBLE} className="text-gray-900 underline">
            Aller a Mon Assistant
          </Link>
        </p>
      </div>
    </>
