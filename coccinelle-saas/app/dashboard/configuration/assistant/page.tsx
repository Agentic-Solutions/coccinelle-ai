 ...
 * d'information.
 *
 * Visait /dashboard/sara, elle-meme cassee. Pointe maintenant directement sur
 * la destination finale.
 */
export default function ConfigAssistantRedirect() {
  return (
    <>
      <meta httpEquiv="refresh" content={`0; url=${CIBLE}`} />
      <div className="min-h-screen bg-white flex items-center justify-center px-4">
        <p className="text-gray-600 text-center">
          La configuration de votre assistant a change d&apos;adresse.{' '}
