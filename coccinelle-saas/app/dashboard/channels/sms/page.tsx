  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        {config.enabled && (
          {/* ⛔ Carte « Envoyer un SMS » retiree le 17/08/2026 (chantier CONSENTEMENT).
              Elle postait `{to, message}` LIBRES sur `POST /api/v1/sms/send`, route
              supprimee : c'etait le seul chemin du produit capable de porter du vrai
              demarchage vers un numero quelconque. Un envoi manuel par gabarit nomme
              est au backlog, s'il revient d'un vrai client. */}
        )}
