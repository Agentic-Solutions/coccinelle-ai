...
export const metadata: Metadata = {
  title: 'Politique de confidentialité - Coccinelle.ai',
  description: 'Politique de confidentialité RGPD de Coccinelle.ai. Données collectees, sous-traitants, droits, sécurité.',
};

const tocItems = [
  { id: 'responsable', label: '1. Responsable de traitement' },
  { id: 'engagement', label: '2. Introduction et engagement' },
  { id: 'donnees', label: '3. Données collectees' },
  { id: 'finalites', label: '4. Finalités et bases légales' },
  { id: 'agent-vocal', label: '5. Agent vocal IA' },
  { id: 'donnees-vocales', label: '6. Données vocales' },
  { id: 'localisation', label: '7. Localisation et hébergement' },
  ...
  { id: 'securite', label: '11. Sécurité des données' },
  { id: 'mineurs', label: '12. Mineurs' },
  { id: 'ia', label: '13. IA et décisions automatisées' },
    ...
    <article>
      ...
      <div className="mb-10">
        <div className="flex items-center gap-3 mb-4">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900">Politique de confidentialité</h1>
      ...
      <div className="space-y-12">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-left">
              <tbody className="text-gray-600">
                <tr className="border-b border-gray-100"><td className="py-2.5 pr-4 font-medium text-gray-900">Société</td><td className="py-2.5">Agentic Solutions SASU</td></tr>
                <tr className="border-b border-gray-100 bg-gray-50"><td className="py-2.5 pr-4 font-medium text-gray-900">Representant légal</td><td className="py-2.5">Youssef Amrouche, President</td></tr>
        ...
        <section id="engagement">
          ...
          <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded">
            <p className="text-sm font-semibold text-blue-900 mb-2">Deux catégories de personnes concernées :</p>
            <ul className="list-disc pl-5 space-y-1 text-sm text-blue-800">
              <li><strong>Clients directs</strong> : entreprises abonnées à Coccinelle.ai et leurs utilisateurs</li>
        ...
        <section id="donnees">
          <h2 className="text-xl font-bold text-gray-900 mb-4">3. Données collectees</h2>

          <h3 className="text-base font-semibold text-gray-900 mt-6 mb-3">3.1 Données des clients directs</h3>
          ...
          <ul className="list-disc pl-6 space-y-1 text-gray-600 mb-4">
            ...
            <li>Nom de l&apos;entreprise, secteur d&apos;activité</li>
          ...
          <ul className="list-disc pl-6 space-y-1 text-gray-600 mb-4">
            ...
            <li>Logs d&apos;utilisation et métriques de performance</li>
          </ul>
          ...
          <h3 className="text-base font-semibold text-gray-900 mt-6 mb-3">3.2 Données des tiers appelants</h3>
          <ul className="list-disc pl-6 space-y-1 text-gray-600">
            <li>Numéro de téléphone de l&apos;appelant</li>
            <li>Date, heure et durée de l&apos;appel</li>
            <li>Transcription textuelle de la conversation</li>
            <li>Résumé généré par l&apos;IA</li>
            <li>Données communiquées volontairement (nom, demande de rendez-vous, etc.)</li>
          </ul>
        </section>

        {/* 4. Finalités */}
        <section id="finalites">
          <h2 className="text-xl font-bold text-gray-900 mb-4">4. Finalités et bases légales</h2>
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-left border border-gray-200 rounded-lg overflow-hidden">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-200">
                  ...
                  <th className="py-3 px-4 font-semibold text-gray-900">Base légale RGPD</th>
                </tr>
              </thead>
              <tbody className="text-gray-600">
                ...
                <tr className="border-b border-gray-100"><td className="py-2.5 px-4">Amelioration du service</td><td className="py-2.5 px-4">Analytics anonymes</td><td className="py-2.5 px-4">Art. 6.1.f &mdash; Intérêt legitime</td></tr>
                <tr className="border-b border-gray-100 bg-gray-50"><td className="py-2.5 px-4">Sécurité</td><td className="py-2.5 px-4">Prevention fraude</td><td className="py-2.5 px-4">Art. 6.1.f &mdash; Intérêt legitime</td></tr>
                <tr className="border-b border-gray-100"><td className="py-2.5 px-4">Conservation légale</td><td className="py-2.5 px-4">Obligation fiscale</td><td className="py-2.5 px-4">Art. 6.1.c &mdash; Obligation légale</td></tr>
        ...
        <section id="agent-vocal">
          <h2 className="text-xl font-bold text-gray-900 mb-4">5. Agent vocal IA &mdash; traitement spécifique</h2>
          <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <ul className="list-disc pl-6 space-y-1 text-gray-600 mb-4">
            <li>Transcription en temps réel par reconnaissance vocale (STT)</li>
            <li>Réponses générées par un modèle de langage (LLM)</li>
            <li>Synthèse vocale (TTS) pour la réponse orale</li>
          </ul>
          <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded mb-4">
            <p className="text-sm font-semibold text-blue-900 mb-2">Garanties :</p>
            <ul className="list-disc pl-5 space-y-1 text-sm text-blue-800">
              <li>Aucune prise de décision automatisée au sens de l&apos;article 22 du RGPD</li>
              <li>Les modèles d&apos;IA ne sont <strong>jamais entraines</strong> sur les données de nos clients</li>
              <li>Conservation des transcriptions limitée à 12 mois maximum</li>
            </ul>
          </div>
        ...
        <section id="donnees-vocales">
          <h2 className="text-xl font-bold text-gray-900 mb-4">6. Données vocales &mdash; protections renforcees</h2>
          <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <ul className="list-disc pl-6 space-y-1 text-gray-600">
            <li>Chiffrement renforcé au repos et en transit</li>
            <li>Accès strictement compartimente par tenant (isolation multi-tenant)</li>
            <li>Audit trail complet de chaque accès aux transcriptions</li>
            <li>Suppression définitive et sécurisée a l&apos;expiration du délai de conservation</li>
            <li>Aucun accès humain aux transcriptions sauf obligation légale</li>
          </ul>
        </section>

        {/* 7. Localisation */}
        <section id="localisation">
          <h2 className="text-xl font-bold text-gray-900 mb-4">7. Localisation et hébergement</h2>
            ...
            <table className="w-full text-sm text-left border border-gray-200 rounded-lg overflow-hidden">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-200">
                  ...
                  <th className="py-3 px-4 font-semibold text-gray-900">Hébergeur</th>
                  <th className="py-3 px-4 font-semibold text-gray-900">Localisation</th>
                </tr>
              </thead>
              <tbody className="text-gray-600">
                <tr className="border-b border-gray-100"><td className="py-2.5 px-4">Base de données</td><td className="py-2.5 px-4">Cloudflare D1</td><td className="py-2.5 px-4">Union Européenne</td></tr>
                ...
                <tr><td className="py-2.5 px-4">Fichiers et sauvegardes</td><td className="py-2.5 px-4">Cloudflare R2</td><td className="py-2.5 px-4">Union Européenne</td></tr>
              </tbody>
            </table>
          </div>
        </section>
        ...
        <section id="sous-traitants">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-left border border-gray-200 rounded-lg overflow-hidden">
              ...
              <tbody className="text-gray-600">
                <tr className="border-b border-gray-100"><td className="py-2.5 px-4">Scaleway SAS</td><td className="py-2.5 px-4">Hébergement agent vocal</td><td className="py-2.5 px-4">France</td><td className="py-2.5 px-4">DPA signe</td></tr>
                ...
                <tr className="border-b border-gray-100"><td className="py-2.5 px-4">Mistral AI</td><td className="py-2.5 px-4">Modèle de langage (LLM)</td><td className="py-2.5 px-4">France</td><td className="py-2.5 px-4">DPA signe</td></tr>
                ...
                <tr className="border-b border-gray-100"><td className="py-2.5 px-4">ElevenLabs Inc.</td><td className="py-2.5 px-4">Synthèse vocale (TTS)</td><td className="py-2.5 px-4">USA</td><td className="py-2.5 px-4">CCT Commission EU</td></tr>
        ...
        <section id="conservation">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-left border border-gray-200 rounded-lg overflow-hidden">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-200">
                  <th className="py-3 px-4 font-semibold text-gray-900">Données</th>
              ...
              <tbody className="text-gray-600">
                <tr className="border-b border-gray-100"><td className="py-2.5 px-4">Compte actif</td><td className="py-2.5 px-4">Durée de l&apos;abonnement</td><td className="py-2.5 px-4">Contrat</td></tr>
                <tr className="border-b border-gray-100 bg-gray-50"><td className="py-2.5 px-4">Compte resilie</td><td className="py-2.5 px-4">3 ans</td><td className="py-2.5 px-4">Intérêt legitime</td></tr>
                ...
                <tr className="border-b border-gray-100 bg-gray-50"><td className="py-2.5 px-4">Données des appelants</td><td className="py-2.5 px-4">12 mois maximum</td><td className="py-2.5 px-4">Minimisation RGPD</td></tr>
                ...
                <tr className="border-b border-gray-100 bg-gray-50"><td className="py-2.5 px-4">Données de facturation</td><td className="py-2.5 px-4">10 ans</td><td className="py-2.5 px-4">Code de commerce</td></tr>
        ...
        <section id="droits">
          ...
          <div className="overflow-x-auto mb-4">
            <table className="w-full text-sm text-left border border-gray-200 rounded-lg overflow-hidden">
              ...
              <tbody className="text-gray-600">
                <tr className="border-b border-gray-100"><td className="py-2.5 px-4">Accès</td><td className="py-2.5 px-4">Art. 15</td><td className="py-2.5 px-4">1 mois</td><td className="py-2.5 px-4">privacy@coccinelle.ai</td></tr>
                ...
                <tr className="border-b border-gray-100 bg-gray-50"><td className="py-2.5 px-4">Portabilité</td><td className="py-2.5 px-4">Art. 20</td><td className="py-2.5 px-4">1 mois</td><td className="py-2.5 px-4">Export depuis le dashboard</td></tr>
                ...
                <tr><td className="py-2.5 px-4">Décision automatisée</td><td className="py-2.5 px-4">Art. 22</td><td className="py-2.5 px-4">1 mois</td><td className="py-2.5 px-4">privacy@coccinelle.ai</td></tr>
              </tbody>
            </table>
          </div>
          <div className="p-4 bg-gray-50 rounded-lg text-sm text-gray-600">
            <p className="mb-2">Une piece d&apos;identité pourra être demandee pour verifier votre identité.</p>
            <p className="mb-2">Le délai de réponse est extensible à 3 mois en cas de demande complexe ou de volume important.</p>
            <p className="mb-2">
        ...
        {/* 11. Sécurité */}
        <section id="securite">
          <h2 className="text-xl font-bold text-gray-900 mb-4">11. Sécurité des données</h2>
          ...
          <ul className="list-disc pl-6 space-y-1 text-gray-600 mb-4">
            ...
            <li>Isolation stricte des données par tenant (architecture multi-tenant)</li>
            <li>Principe du moindre privilège pour tous les accès</li>
          </ul>
          <h3 className="text-base font-semibold text-gray-900 mt-4 mb-3">Mesures organisationnelles :</h3>
          <ul className="list-disc pl-6 space-y-1 text-gray-600 mb-4">
            <li>Accès aux données de production limite au personnel strictement autorise</li>
            <li>Journalisation de tous les accès aux données sensibles</li>
            <li>Notification a la CNIL sous 72h en cas de violation de données (art. 33 RGPD)</li>
            <li>Notification aux personnes concernées en cas de risque élevé (art. 34 RGPD)</li>
          </ul>
        </section>
        ...
        {/* 13. IA */}
        <section id="ia">
          <h2 className="text-xl font-bold text-gray-900 mb-4">13. IA et décisions automatisées</h2>
          <ul className="list-disc pl-6 space-y-2 text-gray-600">
            ...
            <li>Les modèles d&apos;IA ne sont <strong className="text-gray-900">jamais entraines</strong> sur les
        ...
        <section id="modifications">
          ...
          <ul className="list-disc pl-6 space-y-1 text-gray-600">
            ...
            <li>Historique des versions conservé pendant 5 ans</li>
            <li>Possibilité de résilier votre abonnement en cas de désaccord avec les nouvelles conditions</li>
          </ul>
