          ...
          {selected ? (
            <div className="p-5 space-y-5">
              ...
              <div>
                ...
                {selected.type === 'call' && (
                  <p className="text-xs text-gray-700 mt-1">Modifiez ce texte directement — c&apos;est exactement ce que l&apos;agent vocal dira.</p>
                )}
                {['rdv', 'knowledge', 'products', 'prospect', 'transfer'].includes(selected.type) && (
                  <p className="text-xs text-gray-700 mt-1">Ce noeud appelle automatiquement l&apos;outil connect&eacute;.</p>
                )}
              </div>
