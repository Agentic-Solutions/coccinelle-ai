...
-- Pour test end-to-end avec numéro 0760762153
...
-- 2. Créer 2 agents immobiliers (pas de table users pour l'instant)
...
-- 4. Créer la catégorie Immobilier pour ce tenant
INSERT INTO product_categories (
  id, tenant_id, key, name, description,
  icon, color, is_system, fields, display_order,
  status, created_at, updated_at
) VALUES (
  'cat_nestenn_realestate',
  'tenant_nestenn_test',
  'real_estate',
  'Immobilier',
