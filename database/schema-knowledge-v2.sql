-- ============================================
-- COCCINELLE.AI - KNOWLEDGE BASE SCHEMA v2.0
-- ============================================

-- Enrichissement tenants
...
ALTER TABLE tenants ADD COLUMN timezone TEXT DEFAULT 'Europe/Paris';
...
ALTER TABLE tenants ADD COLUMN booking_rules TEXT;

-- Enrichissement agents
ALTER TABLE agents ADD COLUMN role TEXT;
ALTER TABLE agents ADD COLUMN bio TEXT;
ALTER TABLE agents ADD COLUMN working_hours TEXT;
...
CREATE INDEX idx_agent_services_agent ON agent_services(agent_id);
CREATE INDEX idx_agent_services_service ON agent_services(service_id);
...
CREATE INDEX idx_knowledge_docs_hash ON knowledge_documents(content_hash);
...
CREATE INDEX idx_faq_tenant ON knowledge_faq(tenant_id);
...
CREATE INDEX idx_snippets_tenant ON knowledge_snippets(tenant_id);

SELECT 'Schema KB v2.0 créé!' AS message;
